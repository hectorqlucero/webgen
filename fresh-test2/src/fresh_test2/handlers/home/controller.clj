(ns fresh_test2.handlers.home.controller
  (:require
   [buddy.hashers :as hashers]
   [clojure.string :as st]
   [fresh_test2.handlers.home.model :refer [get-user get-users update-password]]
   [fresh_test2.handlers.home.view :refer [change-password-view home-view
                                         main-view]]
   [fresh_test2.layout :refer [application error-404]]
   [fresh_test2.models.util :refer [get-session-id]]
