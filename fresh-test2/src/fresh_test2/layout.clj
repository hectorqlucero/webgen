(ns fresh_test2.layout
  (:require
   [clj-time.core :as t]
   [clojure.string :as str]
   [hiccup.page :refer [html5]]
   [fresh_test2.models.crud :refer [config]]
   [fresh_test2.models.util :refer [user-level user-name]]
   [fresh_test2.menu :as menu]
...
(defn menus-private [request]
  (let [{:keys [nav-links dropdowns]} (fresh_test2.menu/get-menu-config)]
