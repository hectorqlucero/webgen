(ns fresh_test2.engine.scaffold
...
(defn generate-hook-stub
  ...
  (let [file-fields (filter #(= :file (:type %)) fields)
    ...
    (str "(ns fresh_test2.hooks." entity-name "\n"
...
(defn generate-edn-content
  ...
  (let [entity-name (name (:entity config))
    ...
    (str ";; AUTO-GENERATED entity configuration for " (:table config) "\n"
         ...
         " ;; :hooks {:before-load :fresh_test2.hooks." entity-name "/before-load\n"
         " ;;         :after-load :fresh_test2.hooks." entity-name "/after-load\n"
         " ;;         :before-save :fresh_test2.hooks." entity-name "/before-save\n"
         " ;;         :after-save :fresh_test2.hooks." entity-name "/after-save\n"
         " ;;         :before-delete :fresh_test2.hooks." entity-name "/before-delete\n"
         " ;;         :after-delete :fresh_test2.hooks." entity-name "/after-delete}\n"
